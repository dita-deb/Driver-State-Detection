...
class AttentionScorer:
    ...
    def __init__(
        ...
        roll_thresh: int, optional
            ...
            Default threshold is 60 degrees.
        ...
        yaw_thresh: int, optional
            ...
            Default threshold is 30 degrees.
    ...
    def get_PERCLOS(self, t_now, fps, ear_score):
        ...
        # Check if fps is valid (greater than zero)
        if fps <= 0:
            raise ValueError("Frames per second (fps) must be greater than zero.")
